...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Parse a line of the file and return the values as float\PYZdq{}\PYZdq{}\PYZdq{}}
...
Traceback (most recent call last):
  File "/home/alberto/teaching/computing/cmepda/slides/latex/snippets/when_to_catch.py", line 12, in <module>
    time, voltage = parse_line(line)
                    ^^^^^^^^^^^^^^^^
  File "/home/alberto/teaching/computing/cmepda/slides/latex/snippets/when_to_catch.py", line 6, in parse_line
