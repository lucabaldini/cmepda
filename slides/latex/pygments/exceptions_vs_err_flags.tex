...
Traceback (most recent call last):
  File "/home/alberto/teaching/computing/cmepda/slides/latex/snippets/exceptions_vs_err_flags.py", line 11, in <module>
    print(cut_before('We all live in a Yellow Submarine', 'Red'))
          ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/home/alberto/teaching/computing/cmepda/slides/latex/snippets/exceptions_vs_err_flags.py", line 5, in cut_before
