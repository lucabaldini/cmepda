...
[Output]
Fitted with 7 function call(s).
/home/alberto/teaching/computing/cmepda/slides/latex/snippets/test_callable.py:23: UserWarning: FigureCanvasAgg is non-interactive, and thus cannot be shown
  plt.show()
\end{Verbatim}