...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Efficient rotation. Cosinus and sinus values are saved in the closure,}
...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{rotate\PYZus{}by\PYZus{}theta}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{)}
