...
\PY{+w}{    }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Class representing a Vector2d \PYZhy{} storing module and angle.\PYZdq{}\PYZdq{}\PYZdq{}}   
    ...
    \PY{k}{def} \PY{n+nf}{x}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{x}\PY{p}{)}\PY{p}{:} \PY{c+c1}{\PYZsh{} this function must have the same name as the property}
\PY{+w}{        }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} Here we actually need to update module and angle\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{v}\PY{o}{.}\PY{n}{x}\PY{p}{)}
