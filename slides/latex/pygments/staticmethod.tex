...
\PY{k}{class} \PY{n+nc}{Angle}\PY{p}{:}
    ...
    \PY{k}{def} \PY{n+nf}{rad2deg}\PY{p}{(}\PY{n}{rad}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{} The self argument is not passed to a static method}
...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{Angle}\PY{o}{.}\PY{n}{rad2deg}\PY{p}{(}\PY{n}{math}\PY{o}{.}\PY{n}{pi}\PY{o}{/}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{Angle}\PY{o}{.}\PY{n}{deg2rad}\PY{p}{(}\PY{l+m+mf}{45.}\PY{p}{)}\PY{p}{)}
