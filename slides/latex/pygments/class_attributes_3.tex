...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{Television}\PY{o}{.}\PY{n}{NUMBER\PYZus{}OF\PYZus{}CHANNELS}\PY{p}{)}
\PY{c+c1}{\PYZsh{} But we can also access it through instances}
\PY{n}{tv} \PY{o}{=} \PY{n}{Television}\PY{p}{(}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{n}{tv}\PY{o}{.}\PY{n}{NUMBER\PYZus{}OF\PYZus{}CHANNELS}\PY{p}{)}
...
\PY{n+nb}{print}\PY{p}{(}\PY{n}{another\PYZus{}tv}\PY{o}{.}\PY{n}{NUMBER\PYZus{}OF\PYZus{}CHANNELS}\PY{p}{)}
