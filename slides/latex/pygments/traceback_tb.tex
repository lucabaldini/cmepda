...
\PY{k}{except} \PY{n+ne}{FileNotFoundError} \PY{k}{as} \PY{n}{e}\PY{p}{:}
    ...
    \PY{n}{traceback}\PY{o}{.}\PY{n}{print\PYZus{}tb}\PY{p}{(}\PY{n}{e}\PY{o}{.}\PY{n}{\PYZus{}\PYZus{}traceback\PYZus{}\PYZus{}}\PY{p}{,} \PY{n}{file}\PY{o}{=}\PY{n}{sys}\PY{o}{.}\PY{n}{stdout}\PY{p}{)}

[Output]
  File "/home/alberto/teaching/computing/cmepda/slides/latex/snippets/traceback_tb.py", line 6, in <module>
