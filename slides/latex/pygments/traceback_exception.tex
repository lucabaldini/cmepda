...
\PY{k}{except} \PY{n+ne}{FileNotFoundError} \PY{k}{as} \PY{n}{e}\PY{p}{:}
    ...
    \PY{k}{with} \PY{n+nb}{open} \PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{traceback.log}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{w}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{k}{as} \PY{n}{logfile}\PY{p}{:}
        ...
        \PY{n}{traceback}\PY{o}{.}\PY{n}{print\PYZus{}exception}\PY{p}{(}\PY{n}{e}\PY{o}{.}\PY{n+nv+vm}{\PYZus{}\PYZus{}class\PYZus{}\PYZus{}}\PY{p}{,} \PY{n}{e}\PY{p}{,} \PY{n}{e}\PY{o}{.}\PY{n}{\PYZus{}\PYZus{}traceback\PYZus{}\PYZus{}}\PY{p}{,} \PY{n}{file}\PY{o}{=}\PY{n}{logfile}\PY{p}{)}
...
Traceback (most recent call last):
  File "/home/alberto/teaching/computing/cmepda/slides/latex/snippets/traceback_exception.py", line 6, in <module>
