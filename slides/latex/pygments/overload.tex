...
\PY{k}{class} \PY{n+nc}{Dog}\PY{p}{(}\PY{n}{Animal}\PY{p}{)}\PY{p}{:}
    \PY{k}{def} \PY{n+nf}{sound}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
\PY{+w}{        }\PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{} This will shadow the method in the base class\PYZdq{}\PYZdq{}\PYZdq{}}
...
\PY{k}{for} \PY{n}{animal} \PY{o+ow}{in} \PY{n}{animals}\PY{p}{:}
    \PY{n+nb}{print}\PY{p}{(}\PY{n}{animal}\PY{o}{.}\PY{n}{sound}\PY{p}{(}\PY{p}{)}\PY{p}{)}
