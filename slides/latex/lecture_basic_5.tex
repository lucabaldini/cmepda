...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \smallskip
    \item Rather surprisingly (at least for me) Smalltalk is still actively used
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \bigskip
    \item As the mane suggest, OOP is very often adopted for modelling systems that are naturally
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \medskip
    \item You just need to specify that the variable belongs to the 
          \emph{namespace} of that specific object, again using the '.' (dot) operator
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Class attributes are definied inside the class body but outside any method and they live
          in the namespace of the class, not of the instances
    \medskip
...
\begin{frame}
  \frametitle{Class attributes and their strange behaviour}
