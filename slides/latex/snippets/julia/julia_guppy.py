...
book High Performance Python, of Micha Gorelick and Ian Ozsvald.
The original file can be found at:
https://github.com/mynameisfiber/high_performance_python/blob/master/01_profiling/guppy/julia1_guppy.py"""
import time
...
def calc_pure_python(desired_width, max_iterations):
    ...
    hp = hpy()
    hp.setrelheap() # set checkpoint to cleanup the output
