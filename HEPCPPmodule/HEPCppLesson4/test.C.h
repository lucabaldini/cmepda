...
// Mon Dec  9 12:35:46 2019 by ROOT version 6.08/00
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   const Int_t kMaxmyParticles = 10000;
...
#ifdef test.C_cxx
test.C::test.C(TTree *tree) : fChain(0) 
{
...
Int_t test.C::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t test.C::LoadTree(Long64_t entry)
{
...
void test.C::Show(Long64_t entry)
{
...
Int_t test.C::Cut(Long64_t entry)
{
